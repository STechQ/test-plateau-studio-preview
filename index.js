...
var QJsonParserV2 = /** @class */ (function () {
    ...
    QJsonParserV2.prototype.Serialize = function (qjson) {
        var bodundary = "".concat(QJsonParserV2.boundary, "\r\n");
        var header = "".concat(QJsonParserV2.headerPrefix, "v2\r\nboundary: ").concat(bodundary, "\r\n").concat(bodundary);
        var serializeFile = function (fileName, type, fileBody) { return "name: ".concat(fileName, "\r\ntype: ").concat(type, "\r\n\r\n").concat(fileBody); };
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.LoadQjson = exports.CreateQui = void 0;
// import { Router } from "./src/Router";
var js_yaml_1 = __importDefault(__webpack_require__(/*! js-yaml */ "../../node_modules/js-yaml/index.js"));
var lazyLoader_1 = __webpack_require__(/*! ../../common/shrimp/helpers/lazyLoader */ "../../common/shrimp/helpers/lazyLoader.ts");
...
var urlHelper_1 = __webpack_require__(/*! ../../common/shrimp/helpers/urlHelper */ "../../common/shrimp/helpers/urlHelper.ts");
var quiRootParent = document.createElement("div");
var quiRoot = document.createElement("div");
quiRootParent.appendChild(quiRoot);
function CreateQui(webSDKCtor) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        var settings, globalLR, componentOptions, renderer, getURL, sdk, config, qjson, err_1, qjson, qjson, err_2, pjsonPath, search, query, leftQueryString, pageName, ux;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, LoadSettings()];
                case 1:
                    settings = _b.sent();
                    return [4 /*yield*/, LoadGlobalLR()];
                case 2:
                    globalLR = _b.sent();
                    return [4 /*yield*/, LoadComponentList(settings === null || settings === void 0 ? void 0 : settings.componentListURL)];
                case 3:
                    ...
                    if (settings.noRelativeQjsonUrl) {
                        getURL = function (url, mode) {
                            if (mode != "ui" || urlHelper_1.UrlHelper.IsDirectUrl(url)) {
                                return undefined;
                            }
                            return url.startsWith("/") ? url : "/" + url;
                        };
                    }
                    sdk = new webSDKCtor(settings, { extensions: {}, getURL: getURL });
                    config = {
                        GlobalLRDict: globalLR,
                        SiteSettings: { compSettings: componentOptions },
                        LRType: settings.rootLangCode
                    };
                    renderer = sdk.CreateRenderer({ mountPoint: quiRoot, config: config });
                    if (!settings.pipelineqjson) return [3 /*break*/, 8];
                    return [4 /*yield*/, LoadQjson(settings.pipelineqjson)];
                case 4:
                    qjson = _b.sent();
                    if (!qjson) return [3 /*break*/, 8];
                    _b.label = 5;
                case 5:
                    _b.trys.push([5, 7, , 8]);
                ...
                case 7:
                    ...
                    return [3 /*break*/, 8];
                case 8:
                    if (!settings.alertqjson) return [3 /*break*/, 10];
                    return [4 /*yield*/, LoadQjson(settings.alertqjson)];
                case 9:
                    qjson = _b.sent();
                    if (qjson) {
                        renderer.settingsQJsons.SetAlertQjson(qjson);
                    }
                    _b.label = 10;
                case 10:
                    if (!settings.loadingqjson) return [3 /*break*/, 12];
                    return [4 /*yield*/, LoadQjson(settings.loadingqjson)];
                case 11:
                    qjson = _b.sent();
                    if (qjson) {
                        renderer.settingsQJsons.SetLoadingQjson(qjson);
                    }
                    _b.label = 12;
                case 12:
                    if (!settings.domainModuleList) return [3 /*break*/, 16];
                    _b.label = 13;
                case 13:
                    _b.trys.push([13, 15, , 16]);
                    return [4 /*yield*/, sdk.LoadModuleCompLists(settings.domainModuleList)];
                case 14:
                    _b.sent();
                    return [3 /*break*/, 16];
                case 15:
                    ...
                    return [3 /*break*/, 16];
                case 16:
                    pjsonPath = settings.rootqjson;
                    search = window.location.search;
                    query = {};
                    if (search) {
                        search = search[0] === '?' ? search.substr(1) : search;
                        search = search.replace(/\?/, "&");
                        query = urlHelper_1.UrlHelper.ParseQuery(search);
                        pjsonPath = query.q ? query.q.splice(0, 1).join("") : pjsonPath;
                    ...
                    if (query.qjsonpath) {
                        ...
                        pjsonPath += "?qjsonpath=" + query.qjsonpath.splice(0, 1);
                        if (query.qjsonpath.length == 0) {
                            delete query.qjsonpath;
                        }
                    }
                    leftQueryString = Object.entries(query).map(function (_a) {
                        var _b = __read(_a, 2), key = _b[0], value = _b[1];
                        return value === null || value === void 0 ? void 0 : value.map(function (eachValue) { return "".concat(encodeURIComponent(key), "=").concat(encodeURIComponent(eachValue)); });
                    }).map(function (item) { return item === null || item === void 0 ? void 0 : item.join("&"); }).join('&');
                    pageName = leftQueryString ? pjsonPath + "?" + leftQueryString : pjsonPath;
                    pjsonPath += ".qjson";
                    renderer.Render({ pjsonPath: pjsonPath, pageName: pageName });
                    ux = sdk.getUXManager();
                    ux.setTheme("default");
...
exports.CreateQui = CreateQui;
function LoadSettings() {
    return __awaiter(this, void 0, void 0, function () {
        var settingsBody, settingsYaml, settings, ex_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, lazyLoader_1.LazyLoader.FetchModuleBody("settings/settings.yaml")];
                case 1:
                    settingsBody = (_a.sent()).body;
                    settingsYaml = js_yaml_1.default.load(settingsBody);
                    if (typeof (settingsYaml) != "object") {
                        throw new Error("settings.yaml has error");
                    }
...
function LoadGlobalLR() {
    return __awaiter(this, void 0, void 0, function () {
        var qJson, globalLR, ex_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, LoadQjson('settings/globalLocalization.qjson')];
                case 1:
                    qJson = _a.sent();
                    globalLR = qJson.clrids;
                    return [2 /*return*/, globalLR];
                case 2:
                    ex_2 = _a.sent();
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
...
function LoadQjson(qjsonPath) {
    return __awaiter(this, void 0, void 0, function () {
        var qJsonString, qJsonExtracted;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, lazyLoader_1.LazyLoader.FetchModuleBody(qjsonPath)];
                case 1:
                    qJsonString = (_a.sent()).body;
                    qJsonExtracted = QJsonExtractHelper_1.QJsonExtractHelper.qJsonExtractor(qJsonString);
                    if (!qJsonExtracted) {
                        throw new Error("qjson has error");
                    }
...
exports.LoadQjson = LoadQjson;
function LoadComponentList(url) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, lazyLoader_1.LazyLoader.FetchModuleBody(url ? "".concat(url, "/componentList.js") : "static/js/componentList.js").then(function (moduleBody) {
                    var settings = lazyLoader_1.LazyLoader.LoadModule(moduleBody.body);
                    if (!settings) {
                        return undefined;
                    }
                    return settings;
...
window.websdk.init(PlateauUIOptions).then(function () {
    var renderer = window.websdk.createRenderer({ mountPoint: quiRoot });
    renderer.open();
    document.body.appendChild(quiRootParent);
});
